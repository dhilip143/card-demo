...
export default function NFCFeaturesSection() {
  ...
  const leftColumnCards = [
    {
      icon: <FiUnlock size={28} color="#E1F9DF" />,
      title: "Easy Access",
      text: "Instantly access and share your information with a simple tap or scan.",
    },
    {
      icon: <FiHeart size={28} color="#E1F9DF" />,
      title: "Eco-Friendly",
      text: "Go green and reduce paper waste with our environmentally friendly cards.",
    },
    {
      icon: <FiClock size={28} color="#E1F9DF" />,
      title: "Time is Money",
      text: "Exchange networking details without manually typing your contact information.",
    },
  ];

  const rightColumnCards = [
    {
      icon: <FiMonitor size={28} color="#E1F9DF" />,
      title: "No App Toggling",
      text: "No app required to edit or share your details. Simple and seamless.",
    },
    {
      icon: <FiBell size={28} color="#E1F9DF" />,
      title: "Grab Attention",
      text: "Spark curiosity with innovative NFC business cards that stand out.",
    },
    {
      icon: <FiBox size={28} color="#E1F9DF" />,
      title: "All-in-One Solution",
      text: "Consolidate all your contact information in one digital platform.",
    },
  ];
  ...
  const FeatureCard = ({ icon, title, text }) => (
    <div
      ref={addToCardsRef}
      className="p-8 rounded-2xl border shadow-lg hover:shadow-xl transition-all duration-300 hover:border-green-500/70 bg-[#1a3319] border-[rgba(34,197,94,0.5)]"
    >
      <div className="flex items-center mb-4">
        <div className="w-12 h-12 rounded-lg flex items-center justify-center mr-4 bg-[rgba(34,197,94,0.2)]">
          {icon}
        </div>
        <h3 className="text-xl font-semibold text-[#E1F9DF]">{title}</h3>
      </div>
      <p className="text-sm leading-relaxed text-[#E1F9DF]">{text}</p>
    </div>
  );
