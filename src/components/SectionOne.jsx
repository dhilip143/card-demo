...
import ButterflyMobile from "/src/components/ButterflyMobile.jsx";
...
const CraftBeautiful = () => {
  ...
  return (
    <div className='md:min-h-screen flex items-center justify-center bg-primary '>
      <section
        ref={sectionRef}
        className='relative w-full pt-72 md:py-16 px-6 p-10 overflow-hidden'
      >
        <div
          ref={containerRef}
          className=' mx-[2%] flex flex-col-reverse lg:flex-row items-center justify-between gap-12 relative'
        >
          <div className='lg:w-1/2 text-center lg:text-left z-10'>
            ...
            <p
              ref={paragraphRef}
              className='text-lg md:text-xl lg:text-2xl text-secondary mb-8 max-w-2xl mx-auto'
            >
              Seamless. Secure. Smart. Experience the next generation of
              contactless technology with NFC-powered solutions.
            </p>

            <div className='flex flex-row gap-4 justify-start items-start sm:justify-center lg:justify-start'>
              {/* Primary Button */}
              <button
                ref={button1Ref}
          ...
          <div className='relative lg:w-1/2 flex lg:hidden items-center justify-center md:-mt-48 md:-mb-72'>
        <ButterflyMobile />
          </div>
        </div>
      </section>
